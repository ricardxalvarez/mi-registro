...
async def login(data: Login, db: Session):
    try:
        ...
        admin_query = db.query(
            ...
            Admins.center_id, Admins.name, Admins.lastName, Admins.created_at
        ...
        teacher_query = db.query(
            ...
            Teachers.center_id, Teachers.name, Teachers.lastName, Teachers.created_at
        ...
        parent_query = db.query(
            ...
            Parents.center_id, Parents.name, Parents.lastName, Parents.created_at
        ...
        student_query = db.query(
            ...
            Students.center_id, Students.name, Students.lastName, Students.created_at
